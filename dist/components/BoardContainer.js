...
var BoardContainer = function (_Component) {
  ...
  function BoardContainer() {
    ...
    }, _this.onDeleteDrop = function (dropResult) {
      if (_this.props.actions && dropResult && dropResult.payload && dropResult.payload.laneId && dropResult.payload.id) {
        _this.props.actions.removeCard({
          laneId: dropResult.payload.laneId,
          cardId: dropResult.payload.id
        });
      }
      if (_this.props.onDraggableDeleteFunction && dropResult && dropResult.payload.laneId && dropResult.payload.id) {
        _this.props.onDraggableDeleteFunction(dropResult);
      }
        ...
        _react2.default.createElement(
          ...
          reducerData.lanes.map(function (lane, index) {
            ...
            var laneToRender = _react2.default.createElement(_Lane2.default, (0, _extends3.default)({
              ...
              index: index,
              showDeleteSection: _this2.props.showDeleteSection,
            ...
            return draggable && laneDraggable ? _react2.default.createElement(
              ...
              {
                key: lane.id,
                className: (lane.id == 'delete_lane' ? 'delete_section' : 'other_droppable_section') + ' ' + (lane.id == 'delete_lane' && !_this2.props.showDeleteSection ? 'hide' : '')
              },
              laneToRender
            );
          })
