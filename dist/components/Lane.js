...
var Lane = function (_Component) {
  ...
  function Lane() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Lane.__proto__ || (0, _getPrototypeOf2.default)(Lane)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return _react2.default.createElement(
        ...
        id == 'delete_lane' && _react2.default.createElement(
          'span',
          { 'data-dragging': isDraggingOver.toString(), className: 'delete_icon' },
          isDraggingOver ? 'delete' : 'delete_outline'
        ),
  ...
  (0, _createClass3.default)(Lane, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (!(0, _isEqual2.default)(this.props.showDeleteSection, nextProps.showDeleteSection)) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        id !== 'delete_lane' && loading && _react2.default.createElement(_Loader2.default, null),
